...
int main() {
    ...
    xTaskCreate(led_task_r, "LED_Task R", 256, NULL, 1, NULL);
    xTaskCreate(btn_task_r, "BTN_Task R", 256, NULL, 1, NULL);

    xTaskCreate(led_task_y, "LED_Task Y", 256, NULL, 1, NULL);
    xTaskCreate(btn_task_y, "BTN_Taks Y", 256, NULL, 1, NULL);
